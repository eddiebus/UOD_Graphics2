...
void TerrainNode::Render()
{
	...
	currentCBuffer.DiffuseCoefficient = XMFLOAT4(0, 0, 0, 0);
	currentCBuffer.SpecularCoefficient = XMFLOAT4(0, 0, 0, 0);
	currentCBuffer.Shininess = 0;
	...
	DeviceContext->RSSetState(OriginalRasterState.Get());
}
